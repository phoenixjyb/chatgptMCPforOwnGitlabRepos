...
> 本文只讲 ReasonFirst **Reasoning Plane 的 ChatGPT 只读 GitLab MCP bridge**。团队日常真实 coding（ActualCoder + Codex/Copilot + GitLab MR）请优先阅读 [TEAM_GUIDE_CN.md](TEAM_GUIDE_CN.md)；整体设计理念见 [ReasonFirst Design Philosophy](DESIGN_PHILOSOPHY.md)。
