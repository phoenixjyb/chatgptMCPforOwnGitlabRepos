...
> This file is retained for alpha.1-alpha.3 compatibility. For the current
> agent-neutral interface, use [CODINGAGENT_QUICKSTART.md](CODINGAGENT_QUICKSTART.md).
> The preferred user-facing command from alpha.4 onward is `codingagent`.
